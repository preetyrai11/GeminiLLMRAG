...
def user_input(user_question):
    ...
    new_db = FAISS.load_local("faiss_index_", embeddings, allow_dangerous_deserialization=True)
...
# PyPDFLoader("/Users/preetyrai/google_gemini_rag/docs/AI Intern Assignment 2.pdf")
